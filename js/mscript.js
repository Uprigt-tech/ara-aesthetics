...
$('.btm i').on('click', function () {
  if (!($('.btm .sub-menu').hasClass('d-block'))) {
    $(this).siblings('.sub-menu').addClass('d-block');
    $('.btm').addClass('active');
  } else {
    $(this).siblings('.sub-menu').removeClass('d-block');
...
$('.ftm i').on('click', function () {
  if (!($('.ftm .sub-menu').hasClass('d-block'))) {
    $(this).siblings('.sub-menu').addClass('d-block');
    $('.ftm').addClass('active');
  } else {
    $(this).siblings('.sub-menu').removeClass('d-block');
    $('.ftm').removeClass('active');
  }
});
$('.bttm i').on('click', function () {
  if (!($('.bttm .sub-menu').hasClass('d-block'))) {
    $(this).siblings('.sub-menu').addClass('d-block');
    $('.bttm').addClass('active');
  } else {
    $(this).siblings('.sub-menu').removeClass('d-block');
    $('.bttm').removeClass('active');
  }
});
$('.mtm i').on('click', function () {
  if (!($('.mtm .sub-menu').hasClass('d-block'))) {
    $(this).siblings('.sub-menu').addClass('d-block');
    $('.mtm').addClass('active');
  } else {
    $(this).siblings('.sub-menu').removeClass('d-block');
    $('.mtm').removeClass('active');
  }
});
$('.arm i').on('click', function () {
  if (!($('.arm .sub-menu').hasClass('d-block'))) {
    $(this).siblings('.sub-menu').addClass('d-block');
    $('.arm').addClass('active');
  } else {
    $(this).siblings('.sub-menu').removeClass('d-block');
...
$('.stm i').on('click', function () {
  if (!($('.stm .sub-menu').hasClass('d-block'))) {
    $(this).siblings('.sub-menu').addClass('d-block');
    $('.stm').addClass('active');
  } else {
    $(this).siblings('.sub-menu').removeClass('d-block');
...
$('.htm i').on('click', function () {
  if (!($('.htm .sub-menu').hasClass('d-block'))) {
    $(this).siblings('.sub-menu').addClass('d-block');
    $('.htm').addClass('active');
  } else {
    $(this).siblings('.sub-menu').removeClass('d-block');
    $('.htm').removeClass('active');
  }
});
